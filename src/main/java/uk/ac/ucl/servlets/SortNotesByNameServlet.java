...
@WebServlet("/sortByName.html")
public class SortNotesByNameServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Note> sortedByNameNotes = noteModel.sortArrayListofNotesByName();
